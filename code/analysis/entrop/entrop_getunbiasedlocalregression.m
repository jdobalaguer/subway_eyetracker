...
function entrop_getunbiasedlocalregression(ep)
    ...
    for i_participant = 1:nb_participants
        ...
        for i_map = 2:length(e.smoothedstations{i_participant})
            ...
            for i_trial = 1:length(e.smoothedstations{i_participant}{i_map})
                ...
                % cross values
                cross_path = cross_map;
                
                % gaze values
                gaze_path = unbiasedgaze_map(i_trial,:);
                if any(gaze_path)
                    ok = 1;
                else
                    ok = 0;
                ...
                % entropy values
                entropy_path = entropy_map;
                
                % bottleneck values
                bottleneck_path = bottleneck_map;
                
                % radius values
                radius_path = radius_map;
                
                % localentropy values
                localentropy_path = localentropy_map(i_trial,:);
                
                % localbottleneck values
                localbottleneck_path = localbottleneck_map(i_trial,:);
                
                % localradius values
                localradius_path = localradius_map(i_trial,:);
    ...
    % store regressors
    ep.unbiasedlocalregression = struct();
    ep.unbiasedlocalregression.beta_c = beta_c;
    ep.unbiasedlocalregression.beta_e = beta_e;
    ep.unbiasedlocalregression.beta_b = beta_b;
    ep.unbiasedlocalregression.beta_r = beta_r;
    ep.unbiasedlocalregression.beta_le = beta_le;
    ep.unbiasedlocalregression.beta_lb = beta_lb;
    ep.unbiasedlocalregression.beta_lr = beta_lr;
    ep.unbiasedlocalregression.beta_all = beta_all;
    
    ep.unbiasedlocalregression.err_c = err_c;
    ep.unbiasedlocalregression.err_e = err_e;
    ep.unbiasedlocalregression.err_b = err_b;
    ep.unbiasedlocalregression.err_r = err_r;
    ep.unbiasedlocalregression.err_le = err_le;
    ep.unbiasedlocalregression.err_lb = err_lb;
    ep.unbiasedlocalregression.err_lr = err_lr;
    
    ep.unbiasedlocalregression.err2_c = err2_c;
    ep.unbiasedlocalregression.err2_e = err2_e;
    ep.unbiasedlocalregression.err2_b = err2_b;
    ep.unbiasedlocalregression.err2_r = err2_r;
    ep.unbiasedlocalregression.err2_le = err2_le;
    ep.unbiasedlocalregression.err2_lb = err2_lb;
    ep.unbiasedlocalregression.err2_lr = err2_lr;
    
    ep.unbiasedlocalregression.xx_c = xx_c;
    ep.unbiasedlocalregression.xx_e = xx_e;
    ep.unbiasedlocalregression.xx_b = xx_b;
    ep.unbiasedlocalregression.xx_r = xx_r;
    ep.unbiasedlocalregression.xx_le = xx_le;
    ep.unbiasedlocalregression.xx_lb = xx_lb;
    ep.unbiasedlocalregression.xx_lr = xx_lr;
    ep.unbiasedlocalregression.yy_g = yy_g;
end
