...
function entrop_plotcorrelation(ep)
    ...
    for i_participant = 1:nb_participants
        ...
        for i_crosstations = 1:nb_sumcrosstations
            ccor_g {i_crosstations}(end+1)  = ep.correlation.cor_g{i_participant}(i_crosstations);
            ccor_c {i_crosstations}(end+1)  = ep.correlation.cor_c{i_participant}(i_crosstations);
            ccor_e {i_crosstations}(end+1)  = ep.correlation.cor_e{i_participant}(i_crosstations);
            ccor_b {i_crosstations}(end+1)  = ep.correlation.cor_b{i_participant}(i_crosstations);
            ccor_r {i_crosstations}(end+1)  = ep.correlation.cor_r{i_participant}(i_crosstations);
            ccor_le{i_crosstations}(end+1)  = ep.correlation.cor_le{i_participant}(i_crosstations);
            ccor_lb{i_crosstations}(end+1)  = ep.correlation.cor_lb{i_participant}(i_crosstations);
            ccor_lr{i_crosstations}(end+1)  = ep.correlation.cor_lr{i_participant}(i_crosstations);
        end
    end
