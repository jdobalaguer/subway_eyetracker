...
function entrop_getcorrelation(ep)
    ...
    % store correlations --------------------------------------------------
    ep.correlation = struct();
    
    % values predicted by each model (+gaze)
    % {nb_participants}{nb_crosstations_in_the_selected_path}
    ep.correlation.yy_g = yy_g;
    ep.correlation.xx_c = xx_c;
    ep.correlation.xx_e = xx_e;
    ep.correlation.xx_b = xx_b;
    ep.correlation.xx_r = xx_r;
    ep.correlation.xx_le = xx_le;
    ep.correlation.xx_lb = xx_lb;
    ep.correlation.xx_lr = xx_lr;
    
    % correlations
    % {nb_participants}[nb_crosstations_in_the_selected_path]
    ep.correlation.cor_g = cor_g;
    ep.correlation.cor_c = cor_c;
    ep.correlation.cor_e = cor_e;
    ep.correlation.cor_b = cor_b;
    ep.correlation.cor_r = cor_r;
    ep.correlation.cor_le = cor_le;
    ep.correlation.cor_lb = cor_lb;
    ep.correlation.cor_lr = cor_lr;
end
